...
def make_script(
    ...
    if objective == "system":
        ...
        from_imports.append(("wfns.eqn.least_squares", "LeastSquaresEquations"))
    elif objective == "variational":
        from_imports.append(("wfns.eqn.twosided_energy", "TwoSidedEnergy"))
    elif objective == "one_energy":
        from_imports.append(("wfns.eqn.onesided_energy", "OneSidedEnergy"))
