...
def find_num_trans(jumbled_set, ordered_set=None, is_creator=True):
    ...
    is_creator : bool
        ...
        to smallest) provided that ordered_set is None
        If False, the objects being ordered are treated as annihilators (from smallest
        to largest) provided that ordered_set is None
        If the ordered_set is not None, then the given ordering is used.
    ...
    if is_creator and ordered_set is None:
