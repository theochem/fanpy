...
class BaseCC(BaseWavefunction):
    ...
    def assign_exops(self, indices=None):
        ...
        TypeError
            ...
            If an element of a sub-list of `exops` is not an int.
        ValueError
        ...
        if indices is None:
            ...
            ex_from, ex_to = indices[0], indices[1]
            exops = []
            for rank in self.ranks:
    ...
    def generate_possible_exops(self, a_inds, c_inds):
        """Yield possible excitation operators from the given creation and annihilation operators.
        ...
        Yields
        ------
        possible_exops : list of list of int
            List of lists of possible excitation operators.
