"""Tests wfns.wavefunction.proj_wavefunctions
"""
from __future__ import absolute_import, division, print_function
from nose.tools import assert_raises
import numpy as np
from wfns.wavefunction.proj_wavefunction import ProjectedWavefunction
from wfns.backend.sd_list import sd_list
from wfns.wavefunction import slater
...
def test_generate_pspace():
    ...
    Taken from wfns.wavefunction.sd_list.sd_list
    """
    test = TestProjectedWavefunction(2, np.ones((3, 3)), np.ones((3, 3, 3, 3)))
